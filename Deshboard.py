...
Este programa permite navegar por las carpetas de la UNIDAD 1,
visualizar el código fuente de las prácticas en Python y ejecutar
los scripts directamente desde un menú interactivo.
"""
...
def mostrar_menu():
    ...
    while True:
        print("\n=== DASHBOARD UNIDAD 1 - PROGRAMACIÓN ORIENTADA A OBJETOS ===")
        ...
        if eleccion_unidad == '0':
            ...
            mostrar_sub_menu(ruta_base)
        else:
            print("Opción no válida. Por favor, intenta de nuevo.")

def mostrar_sub_menu(ruta_unidad):
    sub_carpetas = [
        f.name for f in os.scandir(ruta_unidad)
        if f.is_dir() and f.name != '.venv'
    ]
    while True:
